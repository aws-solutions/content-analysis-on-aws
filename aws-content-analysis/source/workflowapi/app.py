...
from chalice import NotFoundError, BadRequestError, ChaliceViewError, ConflictError, CognitoUserPoolAuthorizer
import boto3
...
def create_workflow_execution(trigger, workflow_execution):
    ...
    try:
        ...
        if create_asset is True:
            ...
            data_type_mapping = {"mp4": "Video", "mp3": "Audio", "txt": "Text", "json": "Text", "ogg": "Video", "mxf": "Video"}
            try:
