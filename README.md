...
#### *Option 1:* Install Content Analysis over an existing MIE stack
...
#### *Option 2:* Install Content Analysis with a new MIE stack
...
Content Analysis creates two S3 buckets that are not automatically deleted. To delete these buckets, use the steps below.
